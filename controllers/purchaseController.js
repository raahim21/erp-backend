...
exports.createPurchase = async (req, res) => {
  ...
  try {
    ...
    if (type !== "Transfer") {
      ...
      if (totalPrice != null && totalPrice !== calculatedTotal) {
        throw new Error("Provided total price does not match unitPrice * quantity");
      }
...
exports.updatePurchase = async (req, res) => {
  ...
  try {
    ...
    if (newType !== "Transfer") {
      if (unitPrice != null || quantity != null) { // If either changed, recalculate
